...
summary: Entdecken Sie lokale ONTAP Cluster über die NetApp Console, damit Sie mit der Verwaltung von Volumes und der Durchführung erweiterter Verwaltungsaufgaben mit dem ONTAP System Manager beginnen können, der über die Konsole verfügbar ist. 
---
= Entdecken Sie lokale ONTAP -Cluster in der NetApp Console
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Entdecken Sie lokale ONTAP Cluster über die NetApp Console, sodass Sie mit der Verwaltung von Volumes und der Durchführung erweiterter Verwaltungsaufgaben mit ONTAP System Manager direkt über die Konsole beginnen können.

.Erforderliche Konsolenrolle:
Speicheradministrator oder Systemintegritätsspezialist.link:https://docs.netapp.com/us-en/console-setup-admin/reference-iam-predefined-roles.html["Informieren Sie sich über die Zugriffsrollen der NetApp Console ."^]
...
Erkennung und Verwaltung mithilfe eines Konsolenagenten:: Diese Option ermöglicht Ihnen die Verwaltung von ONTAP Clustern mithilfe der folgenden Funktionen:
+
--
* Bietet grundlegende Volume-Operationen nativ über die NetApp Console
...
Wenn Sie sich entscheiden, Ihrer NetApp Console einen Konsolenagenten hinzuzufügen, müssen Sie Ihren lokalen Cluster von der Seite *Unentdeckte Systeme* erneut hinzufügen.  Dies ermöglicht die native Verwaltung über die Konsole und den Zugriff auf NetApp -Datendienste.  Anschließend sollten Sie das andere System entfernen.
...
* Der Cluster muss über eine eingehende und ausgehende Verbindung zum NetApp Console Konsolendienst verfügen:
+
...
* Wählen Sie unter *Speicher > Verwaltung > Erkennbare Systeme* einen Cluster aus, den die Konsole basierend auf den ONTAP Clustern, die mit der E-Mail-Adresse für Ihre NetApp Console verknüpft sind, vorab erkannt hat.
...
+
Falls Sie keinen Konsolenagenten haben und die IP-Adresse von der Konsole aus nicht erreichbar ist, werden Sie aufgefordert, einen Konsolenagenten zu erstellen. Wenden Sie sich an Ihren Konsolenadministrator, um einen Konsolenagenten zu erstellen, falls Sie noch keinen haben.
...
--
Die Konsole erkennt ONTAP -Cluster, die mit Ihrer Anmelde-E-Mail verknüpft sind, und zeigt sie als nicht erkannte Cluster auf der Seite „Discoverable systems“ an.  Sie können die Liste der unentdeckten Cluster anzeigen und sie einzeln hinzufügen.

.Informationen zu diesem Vorgang
Beachten Sie Folgendes zu den lokalen ONTAP Clustern, die auf der Seite * Discoverable systems* angezeigt werden:
...
+
** Wenn Sie sich mit Ihrem NSS-Konto bei der Konsole anmelden und zur Seite * Discoverable systems* navigieren, verwendet die Konsole dieses NSS-Konto, um die mit dem Konto verknüpften Cluster zu finden.
** Wenn Sie sich mit einem lokalen Konto oder einer Verbundverbindung bei der Konsole anmelden und zur Seite „Discoverable systems“ navigieren, werden Sie von der Konsole aufgefordert, Ihre E-Mail-Adresse zu bestätigen.  Wenn diese E-Mail-Adresse mit einem NSS-Konto verknüpft ist, verwendet die Konsole diese Informationen, um die mit dem Konto verknüpften Cluster zu finden.


* Die Konsole zeigt nur die ONTAP Cluster an, die erfolgreich AutoSupport Nachrichten an NetApp gesendet haben.
* Um die Inventarliste zu aktualisieren, verlassen Sie die Seite * Discoverable systems*, warten Sie 5 Minuten und kehren Sie dann dorthin zurück.


.Schritte
. Wählen Sie im Navigationsmenü *Speicher > Verwaltung*.
. Wählen Sie auf der Seite * Discoverable systems* die Option *Erkennen* für lokales ONTAP aus.
+
image:screenshot-my-estate-ontap.png["Ein Screenshot der Seite „Discoverable systems“ , der 12 unentdeckte lokale ONTAP Cluster zeigt."]

. Wählen Sie einen Cluster und dann *Erkennen* aus.
+
image:screenshot-my-estate-ontap-discover.png["Ein Screenshot der Seite „Discoverable systems“ , der 12 unentdeckte lokale ONTAP Cluster zeigt."]
